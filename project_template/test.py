...
tfidf = pickle.load(open(os.path.join(BASE_DIR, "data", "final_model.pkl")))
# prospect_docs = pickle.load(open(os.path.join(BASE_DIR, "data", 'prospects.pkl'))).toarray()
prospect_docs = pickle.load(open(os.path.join(BASE_DIR, "data", 'final_prospects.pkl'))).toarray()
# player_docs = pickle.load(open(os.path.join(BASE_DIR, "data", 'players.pkl'))).toarray()
player_docs = pickle.load(open(os.path.join(BASE_DIR, "data", 'final_curr_players.pkl'))).toarray()

# prospect_to_position = json.load(open(os.path.join(BASE_DIR, "data", "prospect_to_position.json")))
prospect_to_position = json.load(open(os.path.join(BASE_DIR, "data", "final_prospect_to_position.json")))
...
ind_to_prospect = json.load(open(os.path.join(BASE_DIR, "data", "final_ind_to_prospect.json")))
# ind_to_player = json.load(open(os.path.join(BASE_DIR, "data", "ind_to_player.json")))
ind_to_player = json.load(open(os.path.join(BASE_DIR, "data", "final_ind_to_curr_player.json")))
